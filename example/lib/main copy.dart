...
import 'package:material_toolkit_example/color_picker.dart';
import 'package:material_toolkit_example/showcase_pages/motion/motion_page.dart';
...
class TokenShowcaseApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      title: 'Material Toolkit Showcase',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: isSmallScreen
          ? AppBar(title: const Text('Material Toolkit'))
          : null,
