...
class XBoxShadowsData extends Equatable {
  ...
  BoxShadow get small =>
      ...
      (throw UnsupportedError(
          XMetricsAttributeErrors.unsupportedError.message(attribute: 'small', location: 'boxShadows')));
  BoxShadow get medium =>
      _medium ??
      (throw UnsupportedError(
          XMetricsAttributeErrors.unsupportedError.message(attribute: 'medium', location: 'boxShadows')));
  BoxShadow get large =>
      _large ??
      (throw UnsupportedError(
          XMetricsAttributeErrors.unsupportedError.message(attribute: 'large', location: 'boxShadows')));
