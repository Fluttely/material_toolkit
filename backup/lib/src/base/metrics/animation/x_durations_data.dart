...
class XDurationsData extends Equatable {
  ...
  bool get areAnimationEnabled =>
      ...
      (throw UnsupportedError(
          XMetricsAttributeErrors.unsupportedError.message(attribute: 'areAnimationEnabled', location: 'durations')));
  Duration get slow =>
      _slow ??
      (throw UnsupportedError(
          XMetricsAttributeErrors.unsupportedError.message(attribute: 'slow', location: 'durations')));
  Duration get regular =>
      _regular ??
      (throw UnsupportedError(
          XMetricsAttributeErrors.unsupportedError.message(attribute: 'regular', location: 'durations')));
  Duration get quick =>
      _quick ??
      (throw UnsupportedError(
          XMetricsAttributeErrors.unsupportedError.message(attribute: 'quick', location: 'durations')));
  @override
