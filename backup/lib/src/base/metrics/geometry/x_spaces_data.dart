...
class XSpacesData extends Equatable {
  ...
  double get superSmall =>
      ...
      (throw UnsupportedError(
          XMetricsAttributeErrors.unsupportedError.message(attribute: 'superSmall', location: 'spaces')));
  double get extraSmall =>
      _extraSmall ??
      (throw UnsupportedError(
          XMetricsAttributeErrors.unsupportedError.message(attribute: 'extraSmall', location: 'spaces')));
  double get small =>
      _small ??
      (throw UnsupportedError(
          XMetricsAttributeErrors.unsupportedError.message(attribute: 'small', location: 'spaces')));
  double get semiSmall =>
      _semiSmall ??
      (throw UnsupportedError(
          XMetricsAttributeErrors.unsupportedError.message(attribute: 'semiSmall', location: 'spaces')));
  double get medium =>
      _medium ??
      (throw UnsupportedError(
          XMetricsAttributeErrors.unsupportedError.message(attribute: 'medium', location: 'spaces')));
  double get semiLarge =>
      _semiLarge ??
      (throw UnsupportedError(
          XMetricsAttributeErrors.unsupportedError.message(attribute: 'semiLarge', location: 'spaces')));
  double get large =>
      _large ??
      (throw UnsupportedError(
          XMetricsAttributeErrors.unsupportedError.message(attribute: 'large', location: 'spaces')));
  double get extraLarge =>
      _extraLarge ??
      (throw UnsupportedError(
          XMetricsAttributeErrors.unsupportedError.message(attribute: 'extraLarge', location: 'spaces')));
  double get superLarge =>
      _superLarge ??
      (throw UnsupportedError(
          XMetricsAttributeErrors.unsupportedError.message(attribute: 'superLarge', location: 'spaces')));
