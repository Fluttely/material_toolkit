...
class XBreakpointsData extends Equatable {
  ...
  Breakpoint get extraSmall =>
      ...
      (throw UnsupportedError(
          XMetricsError.getUnsupportedErrorMessage(attribute: 'extraSmall', location: 'breakpoints')));
  Breakpoint get small =>
      _small ??
      (throw UnsupportedError(XMetricsError.getUnsupportedErrorMessage(attribute: 'small', location: 'breakpoints')));
  Breakpoint get medium =>
      _medium ??
      (throw UnsupportedError(XMetricsError.getUnsupportedErrorMessage(attribute: 'medium', location: 'breakpoints')));
  Breakpoint get large =>
      _large ??
      (throw UnsupportedError(XMetricsError.getUnsupportedErrorMessage(attribute: 'large', location: 'breakpoints')));
